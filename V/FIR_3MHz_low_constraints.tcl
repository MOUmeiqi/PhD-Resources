...
proc add_fir_constraints {args} {
	...
	set_global_assignment -name "DSP_BLOCK_BALANCING" -remove -entity "FIR_3MHz_low_st"
	...
	set_global_assignment -name "DSP_BLOCK_BALANCING" -entity "FIR_3MHz_low_st" "LOGIC ELEMENTS"
}
add_fir_constraints
