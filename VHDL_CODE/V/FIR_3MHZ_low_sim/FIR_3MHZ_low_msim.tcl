...
transcript on
write transcript FIR_3MHZ_low_transcript

# START MEGAWIZARD INSERT VARIABLES
set top_entity FIR_3MHZ_low
...
if {[string match $flow "rtl"] } {
    ...
    if {[file exists FIR_3MHZ_low.vhd]} {vcom -93 -work work FIR_3MHZ_low.vhd}
    if {[file exists FIR_3MHZ_low.v]} {vlog -work work FIR_3MHZ_low.v}
    vcom -93 -work work FIR_3MHZ_low_ast.vhd
    vcom -93 -work work FIR_3MHZ_low_rtl.vhd
