...
for j = 1:sx
    ...
    %
    file_name = ['FIR_3MHZ_low_input.txt'];
    ...
    for i = 1: num_ch
     ...
     % run this output through the model 
      if(bankcount>1)
        output = FIR_3MHZ_low_mlab(data_channel, bank_channel);
      else
        output = FIR_3MHZ_low_mlab(data_channel);
      end
    ...
    file_name = ['FIR_3MHZ_low_model_output'];
