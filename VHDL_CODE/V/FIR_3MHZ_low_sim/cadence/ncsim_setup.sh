...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvhdl -v93 "$QSYS_SIMDIR/FIR_3MHZ_low_rtl.vhd"                           
  ncvhdl -v93 "$QSYS_SIMDIR/FIR_3MHZ_low_ast.vhd"                           
  ncvhdl -v93 "$QSYS_SIMDIR/FIR_3MHZ_low.vhd"                               
  ncvhdl -v93 "$QSYS_SIMDIR/FIR_3MHZ_low_tb.vhd"                            
fi
