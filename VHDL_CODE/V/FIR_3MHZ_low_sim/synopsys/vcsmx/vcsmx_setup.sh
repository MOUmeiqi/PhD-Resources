...
if [ $SKIP_COM -eq 0 ]; then
  ...
  vhdlan -xlrm "$QSYS_SIMDIR/FIR_3MHZ_low_rtl.vhd"                           
  vhdlan -xlrm "$QSYS_SIMDIR/FIR_3MHZ_low_ast.vhd"                           
  vhdlan -xlrm "$QSYS_SIMDIR/FIR_3MHZ_low.vhd"                               
  vhdlan -xlrm "$QSYS_SIMDIR/FIR_3MHZ_low_tb.vhd"                            
fi
