...
# ACDS 13.0sp1 232 win32 2013.08.05.11:25:37
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "FIR_3MHZ_low"
} 
...
alias com {
  ...
  vcom "$QSYS_SIMDIR/FIR_3MHZ_low_rtl.vhd"                           
  vcom "$QSYS_SIMDIR/FIR_3MHZ_low_ast.vhd"                           
  vcom "$QSYS_SIMDIR/FIR_3MHZ_low.vhd"                               
  vcom "$QSYS_SIMDIR/FIR_3MHZ_low_tb.vhd"                            
}
...
alias elab {
  echo "\[exec\] elab"
  vsim -t ps -L work -L work_lib -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cyclonev_ver -L cyclonev_hssi_ver -L cyclonev_pcie_hip_ver -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cyclonev $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  vsim -novopt -t ps -L work -L work_lib -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cyclonev_ver -L cyclonev_hssi_ver -L cyclonev_pcie_hip_ver -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cyclonev $TOP_LEVEL_NAME
}
