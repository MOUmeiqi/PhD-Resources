//altmult_add ADDNSUB_MULTIPLIER_PIPELINE_REGISTER1="CLOCK0" ADDNSUB_MULTIPLIER_REGISTER1="CLOCK0" CBX_DECLARE_ALL_CONNECTED_PORTS="OFF" DEVICE_FAMILY="Cyclone V" DSP_BLOCK_BALANCING="Auto" INPUT_REGISTER_A0="CLOCK0" INPUT_REGISTER_A1="CLOCK0" INPUT_REGISTER_B0="CLOCK0" INPUT_REGISTER_B1="CLOCK0" INPUT_SOURCE_A0="DATAA" INPUT_SOURCE_A1="DATAA" INPUT_SOURCE_B0="DATAB" INPUT_SOURCE_B1="DATAB" MULTIPLIER1_DIRECTION="SUB" MULTIPLIER_REGISTER0="CLOCK0" MULTIPLIER_REGISTER1="CLOCK0" NUMBER_OF_MULTIPLIERS=2 OUTPUT_REGISTER="CLOCK0" port_addnsub1="PORT_UNUSED" port_addnsub3="PORT_UNUSED" REPRESENTATION_A="SIGNED" REPRESENTATION_B="SIGNED" SIGNED_PIPELINE_REGISTER_A="CLOCK0" SIGNED_PIPELINE_REGISTER_B="CLOCK0" SIGNED_REGISTER_A="CLOCK0" SIGNED_REGISTER_B="CLOCK0" SYSTOLIC_DELAY1="UNREGISTERED" SYSTOLIC_DELAY3="UNREGISTERED" WIDTH_A=13 WIDTH_B=13 WIDTH_RESULT=27 clock0 dataa datab ena0 result CARRY_CHAIN="MANUAL" CARRY_CHAIN_LENGTH=48
...
module  mult_add_rom2_altera_mult_add_ed5g
	( 
	clock0,
	dataa,
	datab,
...
`endif
	...
	assign
		result = wire_altera_mult_add_rtl2_result;
endmodule //mult_add_rom2_altera_mult_add_ed5g

//synthesis_resources = altera_mult_add_rtl 1 dsp_mac 1 reg 27 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  mult_add_rom2
	( 
	clock0,
	dataa,
	datab,
...
`endif
	...
	mult_add_rom2_altera_mult_add_ed5g   altera_mult_add1
	( 
	.clock0(clock0),
	.dataa(dataa),
	.datab(datab),
